...
* [Transformers](https://intranet.hbtn.io/rltoken/SUxjHieLFy2Zns80NrZMdw)
...
* [Transformers](https://intranet.hbtn.io/rltoken/SUxjHieLFy2Zns80NrZMdw "Transformers")
...
At the end of this project, you are expected to be able to [explain to anyone](https://intranet.hbtn.io/rltoken/DNQx_XPYHnFzwmlJCKgy5A "explain to anyone"), **without the help of Google**:
...
* An RNN
* A transformer
* A method for determining which terms are most important in a sequence -> asw
* None of the above
...
* Is a novel neural network -> asw
* Utilizes the Attention mechanism -> asw
* Utilizes RNNs
* Utilizes Fully Connected Networks -> asw
* Utilizes CNNs
* Utilizes dropout -> asw
* Utilizes layer normalization -> asw
...
* It introduced self-supervised learning techniques -> asw
* It utilized layer normalization for the first time
* It can be fine tuned for various NLP tasks -> asw
...
* It normalizes the layer output for each example instead of across the batch -> asw
